...
- **Dev server**: `bun dev` starts Next.js on port 3000. The server auto-creates the SQLite DB and data directories on startup. Document extraction uses `@xberg-io/xberg` (no Rust toolchain / local CLI build required).
